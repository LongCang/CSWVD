...
class Config_base(object):
    ...
    def __init__(self, model_name, dataset):
        ...
        # path.dirname(path.dirname(path.dirname(__file__)))这个就相当于获取到了ToxiCN_ex名称
        ...
        self.vocab_dim = 768
        self.fc_hidden_dim = 256 # 全连接层隐藏单元数，设置为 256。
        # self.attention_window = 12
        # self.hidden_size = 768  # mini-batch大小
        ...
        self.alpha1 = 0.5
        self.gamma1 = 4
        # 这些参数可能用于构造特定的损失函数（例如 Focal Loss 中的调节因子）。
        # evaluate
        self.threshold = 0.5                                            # 二分类任务中使用的阈值。
